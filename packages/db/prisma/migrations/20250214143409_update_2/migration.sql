/*
  ...
  - The values [African,American,Latino,Asian,Alaska,Other] on the enum `EthnicityEnum` will be removed. If these variants are still used in the database, this will fail.
